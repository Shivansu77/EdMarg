...
const wishlistRouteV1 = require('./routes/v1/wishlist.route');
...
app.use('/api/v1', wishlistRouteV1);
...
// Export app immediately for Vercel and expose the HTTP server for cPanel/Passenger.
module.exports = app;
module.exports.server = server;
module.exports.startServer = startServer;

// Only listen automatically when invoked directly or on Render.
