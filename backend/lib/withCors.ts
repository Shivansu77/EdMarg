...
function setCorsHeaders(req, res) {
  ...
  // In production we enforce an allow-list; in dev we allow local origins and vercel previews.
  if (origin && (isListedOrigin || (!isProduction && (isLocalOrigin || isVercelApp)))) {
