  ...
  return (
    <section className="overflow-hidden bg-white py-20 lg:py-28 border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="relative w-full overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100 p-10 text-center shadow-lg lg:p-16">
          <div className="relative z-10 mx-auto max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
              <Link
                href="/assessment"
                className="flex items-center justify-center gap-2 rounded-lg bg-black hover:bg-gray-800 px-8 py-3 text-base font-semibold text-white transition-colors w-full sm:w-auto"
              >
