      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          <div className="animate-fade-up">
            ...
            {/* Heading */}
            <h1 className="text-3xl lg:text-[2.75rem] font-semibold text-slate-900 leading-[1.1] mb-5 tracking-tight">
              Stop Guessing. <br />
              <span className="text-emerald-600">Start Building.</span>
            </h1>

            {/* Description */}
            <p className="max-w-lg text-base leading-relaxed text-slate-500 mb-8">
