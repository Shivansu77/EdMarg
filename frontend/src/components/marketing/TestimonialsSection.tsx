    ...
    <section id="success-stories" className="relative overflow-hidden bg-linear-to-br from-emerald-50 via-green-50/50 to-white py-24 lg:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-16 md:mb-24 flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-[2.25rem] font-bold text-slate-900 tracking-tight leading-tight mb-5 max-w-2xl">
          ...
          {TESTIMONIALS.map((t, idx) => (
            ...
            >
              ...
              <div className="flex-1 relative">
                ...
                <p className="relative z-10 text-sm lg:text-base leading-relaxed text-slate-700 font-normal">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 px-6 py-16 sm:px-12 sm:py-20 lg:p-24 shadow-2xl group">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16 max-w-5xl mx-auto">
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl sm:text-3xl font-semibold text-white tracking-tight leading-tight mb-4">
            ...
            <div className="shrink-0">
              <button className="group/btn relative inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-zinc-900 transition-all hover:bg-zinc-50 hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_60px_rgba(255,255,255,0.2)]">
