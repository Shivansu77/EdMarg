      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="relative w-full overflow-hidden rounded-[2.5rem] border border-emerald-400 bg-linear-to-br from-emerald-600 via-emerald-500 to-green-600 p-10 text-center shadow-[0_20px_60px_rgba(16,185,129,0.3)] lg:p-20">
          ...
          <div className="relative z-10 mx-auto max-w-3xl animate-fade-up">
            <h2 className="text-2xl lg:text-3xl font-bold text-white mb-5 tracking-tight drop-shadow-sm">
              Still confused about your career?
            </h2>
            <p className="text-sm text-emerald-50 mb-8 max-w-2xl mx-auto font-normal">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              <Link
                href="/assessment"
                className="group flex items-center justify-center gap-2 rounded-full bg-white hover:bg-emerald-50 px-6 py-3 text-sm font-semibold text-emerald-900 transition-all shadow-[0_8px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_12px_25px_rgba(0,0,0,0.15)] w-full sm:w-auto"
              >
                Take Assessment <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
              </Link>
              <Link
                href="/browse-mentors"
                className="w-full sm:w-auto rounded-full border border-emerald-300/50 bg-white/10 hover:bg-white/20 backdrop-blur-sm px-6 py-3 text-sm font-semibold text-white transition-colors"
              >
                Connect with Mentor
              </Link>
            </div>
