...
const path = 'src/components/mentor/MentorHeader.tsx';
...
const bellRegex = /<button\s*type="button"\s*className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-600 transition-colors hover:bg-gray-100"\s*aria-label="Notifications"\s*>\s*<Bell size=\{18\} \/>\s*<\/button>/;
...
console.log('MentorHeader updated!');
